...
<head>
        <meta charset="utf-8">
        <title>Gallery Layout 01 - Reddrop Buddies - Blood Donation Campaign & Multi-Concept Activism Template</title>
        ...
        <section class="section-content-block section-secondary-bg">
            ...
            <div class="container wow fadeInUp">
                ...
                <div class="no-padding-gallery gallery-carousel owl-carousel" data-items='3'>
                    ...
                    <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/<?php echo $rows['Photo'] ?>">
