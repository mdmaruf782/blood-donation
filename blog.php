...
<head>
        <meta charset="utf-8">
        <title>Blog - Reddrop Buddies - Blood Donation Campaign & Multi-Concept Activism Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <article class="post single-post">
                            ...
                            <div class="single-post-title">
                                ...
                                <h2>
                                    <a href="#">
                                        Give Blood and save three lives or even more.
                                    </a>
                                </h2> <!--  end blog-post-title  -->
                        ...
                        <article class="post single-post">
                            ...
                            <div class="single-post-title">
                                ...
                                <h2>
                                    <a href="#">
                                        Why should we donate blood and am I eligible?
                                    </a>
                                </h2> <!--  end blog-post-title  -->
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="widget site-sidebar">
                            ...
                            <form action="https://templates.bwlthemes.com/blood_donation/v_2/index.php" id="search-form" class="search-form" role="form" method="get">
