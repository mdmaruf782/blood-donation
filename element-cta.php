                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    <a href="#">Home</a>
                                    <ul class="drop-down">
                                        <li><a href="index.php" title="Home Layout 01">Home 01</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="cta-content text-center">
                            ...
                            <a class="btn-theme margin-top-24" href="#">Become Volunteer</a>
                        </div>
                    </div> <!-- end .col-md-12 -->
                </div> <!-- end .row  -->
            </div> <!-- end .container  -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a class="btn btn-theme btn-theme-invert margin-top-12" href="#">BECOME VOLUNTEER</a>
                    </div> <!--  end .col-md-8  -->
                </div> <!--  end .row  -->
            </div>
        </section> 
        ...
        <section class="section-content-block cta-section-3">       
            <div class="container wow fadeIn animated">
                <div class="row">
                    <div class="col-md-12">
                        <div class="cta-content text-center">
                            <a class="cta-video-icon cta-video-icon-invert venobox vbox-item" data-vbtype="video" data-autoplay="true" href="https://www.youtube.com/watch?v=nrJtHemSPW4">
