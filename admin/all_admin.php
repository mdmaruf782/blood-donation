                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       ...
                       $i=0;
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><img src="admin/<?php echo $rows['photo'] ?>" style="height: 50px;width: auto;"></td>
                            ...
                            <td>
                             <a href="admin_details.php?id=<?php echo $rows['id'] ; ?>">
                              <button class="btn btn-outline-primary">View</button>
                              </a>
                              
                               <a href="trash/admin_delete.php?id=<?php echo $rows['id'] ; ?>"> 
                                <button class="btn btn-outline-primary" onclick="confirm()"><i class="far fa-trash-alt"></i></button>
                              </a>
                        ...
                        <script type="text/javascript">
                          function confirm(){
                            if (confirm("Are Your Sure ?")) {
                              window.location.href="trash/admin_delete.php?id=<?php echo $rows['id'] ; ?>";
                            }
                          }
