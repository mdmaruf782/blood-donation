...
$path="../donor/".$unque_img;//for our upload loaction path
//end img function
$assoc_email="SELECT * FROM `donor list` WHERE email='$email' OR phone='$number' OR nid='$nid'";
...
$sql="INSERT INTO `donor list` (`admin`, `date`, `name`, `email`, `phone`, `nid`, `division`, `blood_group`, `birthday`, `photo`, `status`) VALUES ('$admin', '$date', '$name', '$email', '$number','$nid', '$Division', '$group', '$Birthday', '$unque_img', 'active')";
$run_sql=mysqli_query($conn,$sql);
if ($run_sql) {
$_SESSION['successmassage']= "Successfully Donor Added";
}
else{
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">jquery-steps vertical wizard</h4>   <?php echo error(); echo successmassage(); ?>
