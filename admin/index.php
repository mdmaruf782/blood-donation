      ...
      <div class="main-panel">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                      ...
                      <div class="statistics-item">
                        <p>
                          <i class="icon-sm fas far fa-eye mr-2"></i>
                          Views
                        </p>
                        <h2>3500</h2>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h2 class="mb-5">56000 <span class="text-muted h4 font-weight-normal">Donation</span></h2>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2018 unknown. All rights reserved.</span>
