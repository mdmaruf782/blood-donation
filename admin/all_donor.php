          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">All Donor</li>
              </ol>
            </nav>
          </div>
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"> All Donor List</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php 
                        $query="SELECT * FROM `donor list` ORDER BY id DESC";
                       ...
                       $i=0;
                        ...
                        <tr>
                            ...
                            <td>
                             <a href="donor_details_for_admin.php?id=<?php echo $rows['id'] ; ?>">
                              <button class="btn btn-outline-primary">View</button>
                              </a>
                              
                               <a href="trash/donor_delete.php?id=<?php echo $rows['id'] ; ?>"> 
                                <button class="btn btn-outline-primary"><i class="far fa-trash-alt"></i></button>
                              </a>
                              <a href="edit/donor_activity.php?id=<?php echo $rows['id'] ; ?>"> 
