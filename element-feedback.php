...
<head>
        <meta charset="utf-8">
        <title>Element Feedback/Testimonial - Reddrop Buddies - Blood Donation Campaign & Multi-Concept Activism Template</title>
    ...
    <body> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="#">Home</a> / Element Testimonial
                        </p>
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center no-img-separator">
                        ...
                        <h2 class="extra-large">OUR DONORS FEEDBACK</h2>

                    </div> <!-- end .col-sm-10  --> 

                </div>

                <div class="row section-secondary-bg">          
        ...
        <section class="section-content-block section-custom-bg" data-bg_img='images/testimony_feat_bg.jpg' data-bg_size='cover' data-bg_position='top center' data-bg_opacity="0">
            ...
            <div class="container theme-custom-box-shadow  section-pure-white-bg margin-top-48 margin-bottom-48">
        ...
        <section class="section-content-block section-secondary-bg">
            ...
            <div class="container">
                ...
                <div class="row">          
                    ...
                    <div class="testimonial-container owl-carousel text-center section-pure-white-bg">
