...
<head>
        <meta charset="utf-8">
        <title>Gallery Layout 02 - Reddrop Buddies - Blood Donation Campaign & Multi-Concept Activism Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="#">Home</a> / Gallery Layout 02
                        </p>
            ...
            <div class="container wow fadeInUp">
                ...
                <div class="row no-padding-gallery">
                    ...
                    <div class="col-md-3 col-sm-12 gallery-container">
                        ...
                        <a class="gallery-light-box" data-gall="myGallery" href="images/<?php echo $rows['Photo'] ?>">

                            <figure class="gallery-img">

                                <img src="images/<?php echo $rows['Photo'] ?>" alt="gallery image" />
