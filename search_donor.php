...
if (isset($_POST['search'])) {
   ...
   elseif (empty($division) || empty($group)) {
       die();
   }

   else{
   $sql="SELECT * FROM `donor list` WHERE `division` LIKE '$division' AND `blood_group` LIKE '$group' AND status='active'";
                     ...
                     <div class="col-sm-4">
                            ...
                            <div class="team-layout-1 theme-custom-box-shadow theme-custom-box-animation">
                                ...
                                <figure class="team-member">
                                    <a href="#" title="<?php echo $rows['name'] ?>">
                                        <img src="donor/<?php echo $rows['photo'] ?>" alt="<?php echo $rows['name'] ?>"/>
                                    </a>
                                ...
                                <article class="team-info">
                                   ...
                                   <h3 style="color: red"><?php echo $rows['blood_group'] ?></h3>
                                    <h4>From <?php echo $rows['division'] ?></h4>
                                    <h5><i class="fa fa-mobile" style="font-size: 25px;"></i>&nbsp&nbsp<?php echo $rows['phone'] ?></h5>
                                    <p><i class="fa fa-envelope"></i>&nbsp&nbsp<?php echo $rows['email'] ?></p>
                                </article>

                                <div class="team-content">

                                    <div class="team-social-share text-center clearfix">
                                        <a style="width: 100%;background-color: #EF3D32;color: #fff;font-size: 20px;" class="fa fa-phone rectangle" href="<?php echo $rows['phone'] ?>" title="phone"></a>
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <div class="textwidget">                                       
                                        ...
                                        <i class="fa fa-envelope-o fa-contact"></i> <p><a href="#">mdmaruf782@gmail.com</a><br/><a href="#">mdmaruf782@gmail.com</a></p>

                                        <i class="fa fa-location-arrow fa-contact"></i> <p>agrabd chattogram<br/>Sylhet-3100, Bangladesh</p>

                                        <i class="fa fa-phone fa-contact"></i> <p>Office:&nbsp; (+880) 01830617500<br/>Cell:&nbsp; (+880)01830617500</p>                              
                ...
                <div class="container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 text-center">
                            <p class="copyright-text"> Copyright 2018 -  by codefigther. All Rights Reserved. </p>
                        </div>  <!-- end .col-sm-6  -->
