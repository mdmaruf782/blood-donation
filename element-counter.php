...
<head>
    ...
    <body> 
        ...
        <section class="section-content-block section-custom-bg" data-bg_img='images/counter_bg.jpg' data-bg_size='cover' data-bg_position='top center' data-bg_opacity="0.8">
